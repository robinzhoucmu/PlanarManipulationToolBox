% Print out the trajectory x,y,z,qw,qx,qy,qz to execute on the robot.
function [] = PrintPusherCartesianTrajectory(traj_pusherframe, table_z_height, csv_file_path)
