...
pushobj.pose = [shape_info.shape_parameters.radius/2;0;0];
...
finger_traj = PitchCompute(@(t)(1.0), max_quasistatic_vel, ...
    shape_info.shape_parameters.radius, 2 * shape_info.shape_parameters.radius, finger_movement_sample_dt);

simulation_case = SimulationWorld(pushobj, finger_traj, const_mu, finger_radius, 1);
[pose_log] = simulation_case.SimulationRollOut();
